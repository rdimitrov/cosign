...
require (
	...
	github.com/rdimitrov/go-tuf-metadata v0.0.0-20230321173429-ce586616ecef // indirect
...
replace github.com/sigstore/sigstore => /Users/dimitrovr/workspace/sigstore-all/sigstore
